...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden" style={{ background: "var(--bg)", minHeight: "100vh" }}>
      {/* Negative-space spotlight — soft off-center light fall from upper right.
          Left headline side rests in true black; the card feels placed on a lit surface. */}
      <div
        aria-hidden
      ...
      <div className="relative max-w-[1280px] mx-auto px-5 sm:px-8 md:px-12 lg:px-[72px] pt-24 sm:pt-32 md:pt-[140px] pb-28 md:pb-32 min-h-screen flex flex-col justify-center">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_440px] xl:grid-cols-[1fr_480px] gap-12 lg:gap-10 xl:gap-16 items-center">
          {/* LEFT: copy */}
            ...
            <div key={k} className="flex items-center gap-6 md:gap-8 px-6 md:px-8" style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "var(--text-2)" }}>
              <span className="inline-flex items-center gap-2">
                <motion.span
                  ...
                  style={{ width: 8, height: 8, background: "var(--lime)" }}
          ...
          <div className="flex-1 pb-3">
            <motion.span
              ...
              style={{
                ...
                fontSize: 12,
                letterSpacing: "-0.01em",
                boxShadow: "0 4px 16px rgba(201,220,83,0.3)",
              }}
            >
              BAND A
            </motion.span>
